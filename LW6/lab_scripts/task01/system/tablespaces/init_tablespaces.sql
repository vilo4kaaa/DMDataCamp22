...
DATAFILE '/oracle/u02/oradata/VMasyukdb/db_qpt_dw_idx_01.dat'
SIZE 150M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_persons_data_01
DATAFILE '/oracle/u02/oradata/VMasyukdb/db_qpt_person_data_01.dat'
SIZE 150M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_persons_idx_01
DATAFILE '/oracle/u02/oradata/VMasyukdb/db_qpt_person_idx_01.dat'
SIZE 50M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_references_data_01
DATAFILE '/oracle/u02/oradata/VMasyukdb/db_qpt_references_data_01.dat'
SIZE 150M
 AUTOEXTEND ON NEXT 50
 SEGMENT SPACE MANAGEMENT AUTO;

CREATE TABLESPACE ts_references_ext_data_01
DATAFILE '/oracle/u02/oradata/VMasyukdb/db_qpt_ext_references_data_01.dat'
SIZE 20M
 AUTOEXTEND ON
    NEXT 20M
    MAXSIZE 60M
...
DATAFILE '/oracle/u02/oradata/VMasyukdb/db_qpt_references_idx_01.dat'
SIZE 50M
 AUTOEXTEND ON NEXT 50M
 SEGMENT SPACE MANAGEMENT AUTO;
